...
`tools/list` at `https://gateway.pipeworx.io/crc/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/crc32 \
  -H 'Content-Type: application/json' \
  -d '{"text":"Hello, World!"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/crc32`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
